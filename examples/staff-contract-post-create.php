...
$staffContract->save();
//
// /** Set contract position **/
$staffContractPost = new \Arbor\Model\StaffContractPost();
$staffContractPost->setStaffContract($staffContract);
...
$staffContractPostCopy = $api->retrieve(\Arbor\Resource\ResourceType::STAFF_CONTRACT_POST, $staffContractPost->getResourceId());
$hydrator = new \Arbor\Model\Hydrator();
print_r($hydrator->extractArray($staffContractPostCopy));
