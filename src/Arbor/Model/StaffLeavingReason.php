...
class StaffLeavingReason extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return StaffLeavingReason[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::STAFF_LEAVING_REASON);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::STAFF_LEAVING_REASON, $id);
    }
