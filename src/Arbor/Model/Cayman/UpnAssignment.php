...
class UpnAssignment extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CAYMAN_UPN_ASSIGNMENT;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CAYMAN_UPN_ASSIGNMENT);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CAYMAN_UPN_ASSIGNMENT, $id);
    }
