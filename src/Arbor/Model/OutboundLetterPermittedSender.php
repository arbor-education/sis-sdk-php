...
class OutboundLetterPermittedSender extends ModelBase
{
     ...
     * @return \Arbor\Model\OutboundLetterPermittedSender[]|\Arbor\Model\Collection
     * @throws Exception
     */
    ...
    /**
     * @param mixed $id
     * @return \Arbor\Model\OutboundLetterPermittedSender
     * @throws Exception
     */
    public static function retrieve($id)
    {
        $gateway = self::getDefaultGateway();
        if(!$gateway) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        return $gateway->retrieve("OutboundLetterPermittedSender", $id);
    }
