...
class QualifiedTeacherRoute extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_QUALIFIED_TEACHER_ROUTE;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_QUALIFIED_TEACHER_ROUTE);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_QUALIFIED_TEACHER_ROUTE, $id);
    }
