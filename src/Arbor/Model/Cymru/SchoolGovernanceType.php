...
class SchoolGovernanceType extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_SCHOOL_GOVERNANCE_TYPE;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_SCHOOL_GOVERNANCE_TYPE);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_SCHOOL_GOVERNANCE_TYPE, $id);
    }
