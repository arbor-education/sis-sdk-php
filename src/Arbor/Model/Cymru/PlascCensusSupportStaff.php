...
class PlascCensusSupportStaff extends ModelBase
{
    public const DATA_RETURN = 'dataReturn';

    public const SUPPORT_CATEGORY = 'supportCategory';
    ...
    protected $_resourceType = ResourceType::CYMRU_PLASC_CENSUS_SUPPORT_STAFF;

    /**
     * @param Query $query
     * @return PlascCensusSupportStaff[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_PLASC_CENSUS_SUPPORT_STAFF);
    ...
    /**
     * @param int $id
     * @return PlascCensusSupportStaff
     * @throws Exception
     */
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_PLASC_CENSUS_SUPPORT_STAFF, $id);
    }
    ...
    {
        return $this->getProperty('supportCategory');
    }

    /**
     * @param string $supportCategory
     */
    public function setSupportCategory(string $supportCategory = null)
    {
        $this->setProperty('supportCategory', $supportCategory);
    }
