...
class PlascCensusPupilReconciliation extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_PLASC_CENSUS_PUPIL_RECONCILIATION;

    /**
     * @param Query $query
     * @return PlascCensusPupilReconciliation[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_PLASC_CENSUS_PUPIL_RECONCILIATION);
    ...
    /**
     * @param int $id
     * @return PlascCensusPupilReconciliation
     * @throws Exception
     */
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_PLASC_CENSUS_PUPIL_RECONCILIATION, $id);
    }
