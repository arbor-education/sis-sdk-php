...
class PositionCategory extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_POSITION_CATEGORY;

    /**
     * @param Query $query
     * @return PositionCategory[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_POSITION_CATEGORY);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_POSITION_CATEGORY, $id);
    }
