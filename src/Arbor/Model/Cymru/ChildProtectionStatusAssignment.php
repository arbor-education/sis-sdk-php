...
class ChildProtectionStatusAssignment extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_CHILD_PROTECTION_STATUS_ASSIGNMENT;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_CHILD_PROTECTION_STATUS_ASSIGNMENT);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_CHILD_PROTECTION_STATUS_ASSIGNMENT, $id);
    }
