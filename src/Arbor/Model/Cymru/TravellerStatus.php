...
class TravellerStatus extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_TRAVELLER_STATUS;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_TRAVELLER_STATUS);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_TRAVELLER_STATUS, $id);
    }
