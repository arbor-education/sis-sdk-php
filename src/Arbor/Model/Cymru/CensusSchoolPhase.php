...
class CensusSchoolPhase extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CYMRU_CENSUS_SCHOOL_PHASE;
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CYMRU_CENSUS_SCHOOL_PHASE);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CYMRU_CENSUS_SCHOOL_PHASE, $id);
    }
