...
class UkJcq_QualificationAvailabilityInstance extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkJcq_QualificationAvailabilityInstance[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkJcq_QualificationAvailabilityInstance
     * @throws Exception
     */
