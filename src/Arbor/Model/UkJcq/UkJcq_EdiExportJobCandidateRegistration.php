...
class UkJcq_EdiExportJobCandidateRegistration extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkJcq_EdiExportJobCandidateRegistration[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkJcq_EdiExportJobCandidateRegistration
     * @throws Exception
     */
