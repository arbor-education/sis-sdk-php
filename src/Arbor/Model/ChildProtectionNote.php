...
class ChildProtectionNote extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::CHILD_PROTECTION_NOTE;

    /**
     * @param Query $query
     * @return ChildProtectionNote[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::CHILD_PROTECTION_NOTE);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::CHILD_PROTECTION_NOTE, $id);
    }
