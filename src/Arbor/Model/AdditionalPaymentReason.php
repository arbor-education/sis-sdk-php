...
class AdditionalPaymentReason extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return AdditionalPaymentReason[] | Collection
     * @throws Exception
     */
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::ADDITIONAL_PAYMENT_REASON);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::ADDITIONAL_PAYMENT_REASON, $id);
    }
