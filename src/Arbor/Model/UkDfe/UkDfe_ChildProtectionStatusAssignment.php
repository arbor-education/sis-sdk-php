...
class UkDfe_ChildProtectionStatusAssignment extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_ChildProtectionStatusAssignment[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_ChildProtectionStatusAssignment
     * @throws Exception
     */
