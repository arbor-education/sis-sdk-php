...
class UkDfe_SchoolWorkforceCensusVacancy extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_SchoolWorkforceCensusVacancy[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_SchoolWorkforceCensusVacancy
     * @throws Exception
     */
