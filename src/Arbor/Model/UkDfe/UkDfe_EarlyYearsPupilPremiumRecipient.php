...
class UkDfe_EarlyYearsPupilPremiumRecipient extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_EarlyYearsPupilPremiumRecipient[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_EarlyYearsPupilPremiumRecipient
     * @throws Exception
     */
