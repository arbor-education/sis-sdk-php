...
class UkDfe_SchoolWorkforceCensusAgencyTpSupportCount extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_SchoolWorkforceCensusAgencyTpSupportCount[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_SchoolWorkforceCensusAgencyTpSupportCount
     * @throws Exception
     */
