...
class UkDfe_SchoolWorkforceCensusStaffInformation extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_SchoolWorkforceCensusStaffInformation[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_SchoolWorkforceCensusStaffInformation
     * @throws Exception
     */
