...
class UkDfe_EducationalInstitutionEnrolment extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_EducationalInstitutionEnrolment[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_EducationalInstitutionEnrolment
     * @throws Exception
     */
