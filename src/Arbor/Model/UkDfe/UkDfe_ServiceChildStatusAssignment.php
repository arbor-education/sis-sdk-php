...
class UkDfe_ServiceChildStatusAssignment extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_ServiceChildStatusAssignment[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_ServiceChildStatusAssignment
     * @throws Exception
     */
