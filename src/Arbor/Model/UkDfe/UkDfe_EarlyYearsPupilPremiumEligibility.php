...
class UkDfe_EarlyYearsPupilPremiumEligibility extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_EarlyYearsPupilPremiumEligibility[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_EarlyYearsPupilPremiumEligibility
     * @throws Exception
     */
