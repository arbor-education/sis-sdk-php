...
class UkDfe_SchoolCensusPupilReconciliation extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return UkDfe_SchoolCensusPupilReconciliation[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return UkDfe_SchoolCensusPupilReconciliation
     * @throws Exception
     */
