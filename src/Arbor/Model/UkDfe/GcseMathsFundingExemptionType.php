...
class GcseMathsFundingExemptionType extends ModelBase
{
    ...
    public static function query(\Arbor\Query\Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::UK_DFE_GCSE_MATHS_FUNDING_EXEMPTION_TYPE);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::UK_DFE_GCSE_MATHS_FUNDING_EXEMPTION_TYPE, $id);
    }
