...
class Group_GradeSet extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::GROUP_GRADE_SET;

    /**
     * @param Query $query
     * @return Group_GradeSet[] | Collection
     * @throws Exception
     */
    public static function query(Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::GROUP_GRADE_SET);
    ...
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::GROUP_GRADE_SET, $id);
    }
