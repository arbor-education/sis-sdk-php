...
class Group_AssessmentDerivation extends ModelBase
{
    ...
    protected $_resourceType = ResourceType::GROUP_ASSESSMENT_DERIVATION;

    /**
     * @param Query $query
     * @return Group_AssessmentDerivation[] | Collection
     * @throws Exception
     */
    public static function query(Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::GROUP_ASSESSMENT_DERIVATION);
    ...
    /**
     * @param int $id
     * @return Group_AssessmentDerivation
     * @throws Exception
     */
    public static function retrieve($id)
    {
        ...
        return $gateway->retrieve(ResourceType::GROUP_ASSESSMENT_DERIVATION, $id);
    }
