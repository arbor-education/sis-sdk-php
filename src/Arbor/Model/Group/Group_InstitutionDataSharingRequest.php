...
class Group_InstitutionDataSharingRequest extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return Group_InstitutionDataSharingRequest[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return Group_InstitutionDataSharingRequest
     * @throws Exception
     */
