...
class Group_EducationalInstitution extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return Group_EducationalInstitution[] | Collection
     * @throws Exception
     */
    public static function query(Query $query = null)
    {
        ...
        $query->setResourceType(ResourceType::GROUP_EDUCATIONAL_INSTITUTION);
    ...
    /**
     * @param int $id
     * @return Group_EducationalInstitution
     * @throws Exception
     */
