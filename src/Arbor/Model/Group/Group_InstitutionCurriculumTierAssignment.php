...
class Group_InstitutionCurriculumTierAssignment extends ModelBase
{
    ...
    /**
     * @param Query $query
     * @return Group_InstitutionCurriculumTierAssignment[] | Collection
     * @throws Exception
     */
    ...
    /**
     * @param int $id
     * @return Group_InstitutionCurriculumTierAssignment
     * @throws Exception
     */
