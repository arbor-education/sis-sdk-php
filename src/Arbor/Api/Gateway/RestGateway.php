...
class RestGateway implements GatewayInterface
{
    ...
    public function refresh($model)
    {
        ...
        else throw new Exception("Resource {$model->getResourceType()} with ID {$model->getResourceId()} could not be retrieved from URL: $url");
    }
    ...
    public function retrieve($resource, $id)
    {
        ...
        else throw new Exception("Resource $resource with ID $id could not be retrieved from URL: $url");
    }
    ...
    public function instantiateModel($resourceType)
    {
        ...
        {
            $model = new $modelClass($resourceType, array(), $this);
        }
        else
        {
            $model = new ModelBase($resourceType, array(), $this);
        }
        return $model;
    }
	...
	$response = NULL;
        ...
        {
            throw new ServerErrorException("The server did not return a valid response from URL=$url. Response: ".
