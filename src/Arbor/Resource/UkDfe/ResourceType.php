...
class ResourceType {
	...
	const UK_DFE_PUPIL_PREMIUM_RECIPIENT_IMPORT = 'UkDfe_PupilPremiumRecipientImport';
	const UK_DFE_PUPIL_PREMIUM_RECIPIENT_IMPORT_JOB = 'UkDfe_PupilPremiumRecipientImportJob';
